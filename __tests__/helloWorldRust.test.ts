...
it(`should parse sections`,() => {
    ...
    expect(functions.imported[1].type!.result).toBe(PrimitiveTypes.i32);

    expect(functions.internal[2].name).toBe("greet");
    ...
    expect(functions.internal[3].name).toBe("<&'a_T_as_core::fmt::Display>::fmt::h10d15eeb4044458d");
    ...
    expect(functions.internal[4].name).toBe("dlmalloc::dlmalloc::Dlmalloc::malloc::hce1b00d5aca5677c");
    ...
    expect(functions.internal[5].name).toBe("core::fmt::write::h533d40856339be39");
    ...
    expect(functions.internal[6].name).toBe("dlmalloc::dlmalloc::Dlmalloc::free::h4c32f8306a59a4b8");
    ...
    expect(functions.internal[7].name).toBe("rust_oom");
    ...
    expect(functions.internal[7].body).toEqual(
...
0001973: 04                                        ; FIXUP func body size`.split("\n"));
    ...
    expect(functions.internal[8].name).toBe("core::result::unwrap_failed::ha655e72972fab217");
    ...
    expect(functions.internal[9].name).toBe("wasm_bindgen::throw::hb552665eadbe0155");
    ...
    expect(functions.internal[10].name).toBe("__wbindgen_malloc");
    ...
    expect(functions.internal[11].name).toBe("__wbindgen_free");
    ...
    expect(functions.internal[12].name).toBe("std::panicking::rust_panic_with_hook::h9b1c029d1ceaded2");
    ...
    expect(functions.internal[13].name).toBe("rust_begin_unwind");
    ...
    expect(functions.internal[14].name).toBe("std::panicking::begin_panic_fmt::h29d4906ca23d78a0");
    ...
    expect(functions.internal[15].name).toBe("dlmalloc::dlmalloc::Dlmalloc::unlink_large_chunk::hf712b91716024651");
    ...
    expect(functions.internal[16].name).toBe("dlmalloc::dlmalloc::Dlmalloc::insert_large_chunk::hfbbc13dfd26ec0ad");
    ...
    expect(functions.internal[17].name).toBe("dlmalloc::dlmalloc::Dlmalloc::dispose_chunk::hb606175ffa022755");
    ...
    expect(functions.internal[18].name).toBe("core::ptr::drop_in_place::h2745c3a200e8c575");
    ...
    expect(functions.internal[19].name).toBe("alloc::raw_vec::capacity_overflow::h034ca36241ac64a2");
    ...
    expect(functions.internal[20].name).toBe("core::panicking::panic::haf7d7779169c0743");
    ...
    expect(functions.internal[21].name).toBe("<alloc::raw_vec::RawVec<T__A>>::reserve_internal::hd482a5eb753c5a7b");
    ...
    expect(functions.internal[22].name).toBe("__rust_realloc");
    ...
    expect(functions.internal[23].name).toBe("<core::fmt::Error_as_core::fmt::Debug>::fmt::h1e2fd851a36a17f2");
    ...
    expect(functions.internal[24].name).toBe("<&'a_T_as_core::fmt::Display>::fmt::hdc0ef8ca37056d26");
    ...
    expect(functions.internal[25].name).toBe("core::panicking::panic_fmt::h29e5105b4d53bc05");
    ...
    expect(functions.internal[26].name).toBe("<str_as_core::fmt::Display>::fmt::h46b69ad9cae344d8");
    ...
    expect(functions.internal[27].name).toBe("<core::fmt::Write::write_fmt::Adapter<'a__T>_as_core::fmt::Write>::write_char::h7ce04ba63be07a5d");
    ...
    expect(functions.internal[28].name).toBe("<core::fmt::Write::write_fmt::Adapter<'a__T>_as_core::fmt::Write>::write_fmt::h366fb92f1c6d804e");
    ...
    expect(functions.internal[29].name).toBe("<core::fmt::Write::write_fmt::Adapter<'a__T>_as_core::fmt::Write>::write_str::hc67b7914ad867b23");
    ...
    expect(functions.internal[30].name).toBe("core::panicking::panic_bounds_check::h5e0d682eeeb4ea02");
    ...
    expect(functions.internal[31].name).toBe("core::fmt::num::<impl_core::fmt::Display_for_usize>::fmt::h31ff92112cdfbd01");
    expect(functions.internal[31].typeIndex).toBe(3);
    expect(functions.internal[31].functionIndex).toBe(31);
    expect(functions.internal[31].type!.parameters).toEqual([PrimitiveTypes.i32,PrimitiveTypes.i32]);
    expect(functions.internal[31].type!.result).toBe(PrimitiveTypes.i32);

    expect(functions.internal[32].name).toBe("core::fmt::ArgumentV1::show_usize::h31ed957c3096bec9");
    expect(functions.internal[32].typeIndex).toBe(5);
    expect(functions.internal[32].functionIndex).toBe(32);
    expect(functions.internal[32].type!.parameters).toEqual([PrimitiveTypes.i32,PrimitiveTypes.i32,PrimitiveTypes.i32]);
    expect(functions.internal[32].type!.result).toBe(PrimitiveTypes.i32);

    expect(functions.internal[33].name).toBe("core::fmt::Formatter::pad_integral::__closure__::h94fc5aab011b1f92");
    expect(functions.internal[33].functionIndex).toBe(33);


    expect(functions.internal[34].name).toBe("memcpy");
    expect(functions.internal[34].functionIndex).toBe(34);
